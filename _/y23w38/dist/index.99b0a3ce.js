...
e(document).find("[data-"+t+"-bg]").each(function(o,i){var r=e(i),s=r.data(t+"-options"),n=r.data(t+"-bg");r[t](n,s)})})},"function"==typeof define&&define.amd?define(["jquery"],e):e(jQuery);//# sourceMappingURL=index.99b0a3ce.js.map

//# sourceMappingURL=index.99b0a3ce.js.map
